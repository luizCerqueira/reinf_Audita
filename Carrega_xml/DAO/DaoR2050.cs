...
namespace DAO
{
	public class DaoR2050 : IDAO<R2050>
	{
		...
		public bool Save(R2050 entidade, string Banco, int Codigo, string Id)
		{
			try
			{

				string strQuery = "INSERT INTO [dbo].[R2050]([indRetif],[nrRecibo],[perApur],[tpAmb],[procEmi],[verProc],[tpInsc],[nrInsc],[tpInscEstab],[nrInscEstab],[vlrRecBrutaTotal],[vlrCPApur],[vlrRatApur],[vlrSenarApur],[vlrCPSuspTotal],[vlrRatSuspTotal],[vlrSenarSuspTotal],[R1000],[Id])";
