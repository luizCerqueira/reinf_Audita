...
namespace DAO
{
	public class DaoR5011 : IDAO<R5011>
	{
		...
		public bool Save(R5011 entidade, string Banco, int Id, string Chave)
		{
			try
			{
				string strQuery = "INSERT INTO [dbo].[R5011]([perApur],[tpInsc],[nrInsc],[cdRetorno],[descRetorno],[tpOcorr],[localErroAviso],[codResp],[dscResp],[R1000],[Chave])";
