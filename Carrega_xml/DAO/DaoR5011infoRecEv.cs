...
namespace DAO
{
	public class DaoR5011infoRecEv : IDAO<R5011infoRecEv>
	{
		...
		public bool Save(R5011infoRecEv entidade, string Banco, int Id, string Chave)
		{
			try
			{

				string strQuery = "INSERT INTO [dbo].[R5011infoRecEv]([nrProtEntr],[dhProcess],[tpEv],[idEv],[hash],[R5011],[Chave])";
