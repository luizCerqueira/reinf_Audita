...
namespace DAO
{
	public class DaoR1070inclusao : IDAO<R1070inclusao>
	{
		...
		public bool Save(R1070inclusao entidade, string Banco, int Id, string Chave)
		{
			try
			{
				string strQuery = "INSERT INTO [dbo].[R1070inclusao]([tpProc],[nrProc],[iniValid],[fimValid],[indAutoria],[codSusp],[indSusp],[dtDecisao],[indDeposito],[ufVara],[codMunic],[idVara],[R1070],[Chave])";
