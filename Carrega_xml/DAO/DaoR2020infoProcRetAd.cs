...
namespace DAO
{
	public class DaoR2020infoProcRetAd : IDAO<R2020infoProcRetAd>
	{
		...
		public bool Save(R2020infoProcRetAd entidade, string Banco, int Id, string Chave)
		{
			try
			{
				string strQuery = "INSERT INTO [dbo].[R2020infoProcRetAd]([tpProcRetAdic],[nrProcRetAdic],[codSuspAdic],[valorAdic],[R2020ideTomador],[Chave])";
