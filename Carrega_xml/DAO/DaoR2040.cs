...
namespace DAO
{
	public class DaoR2040 : IDAO<R2040>
	{
		...
		public bool Save(R2040 entidade, string Banco, int Codigo, string Id)
		{
			try
			{

				string strQuery = "INSERT INTO [dbo].[R2040]([indRetif],[nrRecibo],[perApur],[tpAmb],[procEmi],[verProc],[tpInsc],[nrInsc],[tpInscEstab],[nrInscEstab],[R1000],[Id])";
